#!/usr/bin/env python3
"""
Launch RViz visualization for the robot.
...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/myrobot_ros2/myrobot_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/myrobot_moveit_config/share/myrobot_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='myrobot_280',
...
def generate_launch_description():
    ...
    the myrobot robot in RViz, including:
    ...
    """
    # Define filenames
    urdf_package = 'myrobot_description'
    urdf_filename = 'myrobot_280.urdf.xacro'
    rviz_config_filename = 'myrobot_280_description.rviz'
